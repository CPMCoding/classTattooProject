...
<head>
    ...
    <title>The Inkredibles: Christopher Martin</title>
    ...
    <style>
		...
		#masked {
			-webkit-mask-image: url(img/irregularmask.png);
			mask-image: url(img/irregularmask.png);
...
<body>
    ...
    <div class="content">
        ...
        <div class="artist-box">
            ...
            <div id="columns">
                <div id="leftcol">
                    <img src="img/tat11.jpg" alt="Artist 1 Picture 4" width=96% class=masked id=masked>
					<p>
                    <img src="img/tat12.webp" alt="Artist 1 Picture 5" width=96% class=masked id=masked>
					<p>
                    <img src="img/tat13.jpg" alt="Artist 1 Picture 2" width=96% class=masked id=masked>
					<p>
                    <img src="img/tat14.webp" alt="Artist 1 Picture 2" width=96% class=masked id=masked>
                </div>
                <div id="rightcol">
                    <img src="img/realismTattoo_1.jpg" alt="Artist 1 Picture 1" width=97% class=masked id=masked>
					<p>
                    <img src="img/realismTattoo_2.jpg" alt="Artist 1 Picture 2" width=97% class=masked id=masked>
					<p>
                    <img src="img/realismTattoo_3.jpg" alt="Artist 1 Picture 3" width=97% class=masked id=masked>
					<p>
                    <img src="img/tat15.jpg" alt="Artist 1 Picture 2" width=97% class=masked id=masked>
					<p>
                    <img src="img/tat16.jpg" alt="Artist 1 Picture 2" width=97% class=masked>
                </div>
