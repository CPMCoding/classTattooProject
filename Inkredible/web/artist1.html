...
<head>
    ...
    <title>The Inkredibles: Jose Garcia</title>
...
<body>
    ...
    <div class="content">
        ...
        <div class="artist-box">
            ...
            <div id="columns">
                <div id="leftcol">
                    <img src="img/geotat01.webp" alt="Artist 1 Picture 4" width=96% class=masked id=masked>
					<p>
                    <img src="img/geotat02.webp" alt="Artist 1 Picture 5" width=96% class=masked id=masked>
					<p>
                    <img src="img/geotat03.jpg" alt="Artist 1 Picture 2" width=96% class=masked id=masked>
					<p>
                    <img src="img/geotat04.jpg" alt="Artist 1 Picture 2" width=96% class=masked id=masked>
					<p>
                    <img src="img/geotat05.jpg" alt="Artist 1 Picture 2" width=96% class=masked id=masked>
                </div>
                <div id="rightcol">
                    <img src="img/geotat05.jpg" alt="Artist 1 Picture 1" width=97% class=masked id=masked>
					<p>
                    <img src="img/geotat07.jfif" alt="Artist 1 Picture 2" width=97% class=masked id=masked>
					<p>
                    <img src="img/geotat08.jpg" alt="Artist 1 Picture 3" width=97% class=masked id=masked>
					<p>
                    <img src="img/geotat10.jpg" alt="Artist 1 Picture 2" width=97% class=masked id=masked>
					<p>
                    <img src="img/geotat12.webp" alt="Artist 1 Picture 2" width=97% class=masked id=masked>
                </div>
